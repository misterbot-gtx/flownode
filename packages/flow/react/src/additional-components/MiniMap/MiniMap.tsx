...
import { getInternalNodesBounds, getBoundsOfRects, XYMinimap, type Rect, type XYMinimapInstance } from '@flow/system';
...
function MiniMapComponent<NodeType extends Node = Node>({
  ...
  const minimapInstance = useRef<XYMinimapInstance | null>(null);
